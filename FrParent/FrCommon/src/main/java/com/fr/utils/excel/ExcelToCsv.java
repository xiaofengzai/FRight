...
import com.fr.utils.FileUtils;
import com.fr.utils.StringUtils;
...
public class ExcelToCsv {
    private static final Logger logger=Logger.getLogger(ExcelToCsv.class);
    private static DecimalFormat df = new DecimalFormat("0");
    public static Integer transfer(InputStream in,CsvConvertConfig config){
        Integer rowCount=0;
