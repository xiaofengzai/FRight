...
public class EnumUtils {
    ...
    public static <T extends EnumMessage> T toEnum(String displayName, Class<T> enumClass)  {
        if(displayName == null)
            return null;
    ...
    private static <T> Map<?,EnumMessage> getEnumValueMap(Class<T> enumClass){
        ...
        enumValueMap = Arrays.stream(enumItems).collect(Collectors.toMap(EnumMessage::getValue, EnumMessage->EnumMessage));
